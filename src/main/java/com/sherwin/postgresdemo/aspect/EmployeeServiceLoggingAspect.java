...
public class EmployeeServiceLoggingAspect {
     ...
     * @param joinPoint
     */
    @Before("execution(* com.sherwin.postgresdemo.employee.EmployeeService.findAll(..))")
     ...
     * @param joinPoint
     */
    @After("execution(* com.sherwin.postgresdemo.employee.EmployeeService.findAll(..))")
     ...
     * @param result
     */
    @AfterReturning(pointcut = "execution(* com.sherwin.postgresdemo.employee.EmployeeService.delete(..))", returning = "result")
	 ...
	 * @throws Throwable
	 */
	@Around("execution(* com.sherwin.postgresdemo.employee.EmployeeService.get(..))")
	...
	@AfterThrowing(pointcut = "execution(* com.sherwin.postgresdemo.employee.EmployeeService.save(..))", throwing = "error")
